...
CREATE TABLE `educacion` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_educacion_persona1_idx` (`id_persona`),
  CONSTRAINT `fk_educacion_persona1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`)
...
CREATE TABLE `experiencia_laboral` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_experiencia_laboral_persona_idx` (`id_persona`),
  KEY `fk_experiencia_laboral_tipo_empleo1_idx` (`id_tipo_empleo`),
  CONSTRAINT `fk_experiencia_laboral_persona` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`),
  CONSTRAINT `fk_experiencia_laboral_tipo_empleo1` FOREIGN KEY (`id_tipo_empleo`) REFERENCES `tipo_empleo` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `persona` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_persona_domicilio1_idx` (`id_domicilio`),
  KEY `fk_persona_usuarios1_idx` (`id_usuarios`),
  CONSTRAINT `fk_persona_domicilio1` FOREIGN KEY (`id_domicilio`) REFERENCES `domicilio` (`id`),
  CONSTRAINT `fk_persona_usuarios1` FOREIGN KEY (`id_usuarios`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `proyectos` (
  ...
  `id_persona` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_proyectos_persona1_idx` (`id_persona`),
  CONSTRAINT `fk_proyectos_persona1` FOREIGN KEY (`id_persona`) REFERENCES `persona` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-06-28 15:51:42
